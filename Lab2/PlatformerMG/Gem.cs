...
namespace PlatformerMG
{
    ...
    class Gem
    {
        ...
        public Gem(Level level, Vector2 position)
        {
            ...
            this.Color = GameInfo.Instance.GemInfo.Color;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            double t = gameTime.TotalGameTime.TotalSeconds * GameInfo.Instance.GemInfo.BounceRate + Position.X * BounceSync;
            bounce = (float)Math.Sin(t) * GameInfo.Instance.GemInfo.BounceHeight * texture.Height;
        }
